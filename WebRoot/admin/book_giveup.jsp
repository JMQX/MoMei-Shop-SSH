...
<script type="text/javascript">
	...
	function delbooksList()
	{
		...
		if(isSelected==true)
		{
			...
			{
				document.form1.action="BookServlet?flag=delete_some&statu=giveup";
	...
	function find_book()
	{
	    ...
	    {
	        document.form1.action="BookServlet?flag=find&statu=4";
	       document.form1.submit();
	     }
	}
		...
		<td height="20" bgcolor="#FFFFFF">
			<div align="center" class="STYLE21">
				<a
				 ...
				 | <a href="BookServlet?flag=delete&bookId=<%=b.getBookId() %>&pageNow=<%=request.getAttribute("pageNow") %>&statu=giveup"  onclick="return confirm('确定删除吗?')"/>删除</a>
			</div>
		</td>
	</tr>
      <%
      ...
      <tr>
        ...
        <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="49"><div align="center"><a href="BookServlet?flag=check_giveup&pageNow=1"><img src="images/main_54.gif" width="40" height="15" /></a></div></td><!--首页 -->
            <%
               if(Integer.parseInt(request.getAttribute("pageNow").toString())!=1)
               {
             %>
            <td width="49"><div align="center"><a href="BookServlet?flag=check_giveup&pageNow=<%=Integer.parseInt(request.getAttribute("pageNow").toString())-1 %>"><img src="images/main_56.gif" width="45" height="15" /></a></div></td><!--前一页 -->
           <%
           }
            %>
            ...
            <%
              ...
              {
             %>
            <td width="49"><div align="center"><a href="BookServlet?flag=check_giveup&pageNow=<%=Integer.parseInt(request.getAttribute("pageNow").toString())+1 %>"><img src="images/main_58.gif" width="45" height="15" /></a></div></td><!--后一页 -->
            <%
            }
             %>
            <td width="49"><div align="center"><a href="BookServlet?flag=check_giveup&pageNow=<%=request.getAttribute("pageCount") %>"><img src="images/main_60.gif" width="40" height="15" /></a></div></td><!--尾页 -->
