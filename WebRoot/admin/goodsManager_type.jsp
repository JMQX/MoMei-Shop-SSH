...
<body class="p10">
 ...
 <form action="GoodsServlet?flag=showPageType" method="post" name="form1">
       ...
       <tr >
		...
		<td height="20" bgcolor="#FFFFFF">
			<div align="center" class="STYLE21">
				<a
					href="GoodsServlet?flag=up_get&goodsId=<%=g.getGoodsId() %>&pageNow=<%=request.getAttribute("pageNow") %>&type=<%=goodsTypeId %>">修改
				</a>
				 | <a href="GoodsServlet?flag=delete_one&goodsId=<%=g.getGoodsId() %>&pageNow=<%=request.getAttribute("pageNow") %>&type=<%=goodsTypeId %>"  onclick="return confirm('确定要下架吗?')"/>下架</a>
			</div>
		</td>
	</tr>
      <%
      ...
      <tr>
        ...
        <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="49"><div align="center"><a href="GoodsServlet?flag=showPageType&pageNow=1&goodsTypeId=<%=goodsTypeId %>"><img src="images/main_54.gif" width="40" height="15" /></a></div></td><!--首页 -->
            <%
               if(Integer.parseInt(request.getAttribute("pageNow").toString())!=1)
               {
             %>
            <td width="49"><div align="center"><a href="GoodsServlet?flag=showPageType&pageNow=<%=Integer.parseInt(request.getAttribute("pageNow").toString())-1 %>&goodsTypeId=<%=goodsTypeId %>"><img src="images/main_56.gif" width="45" height="15" /></a></div></td><!--前一页 -->
           <%
           }
            %>
            ...
            <%
              ...
              {
             %>
            <td width="49"><div align="center"><a href="GoodsServlet?flag=showPageType&pageNow=<%=Integer.parseInt(request.getAttribute("pageNow").toString())+1 %>&goodsTypeId=<%=goodsTypeId %>"><img src="images/main_58.gif" width="45" height="15" /></a></div></td><!--后一页 -->
            <%
            }
             %>
            <td width="49"><div align="center"><a href="GoodsServlet?flag=showPageType&pageNow=<%=request.getAttribute("pageCount") %>&goodsTypeId=<%=goodsTypeId %>"><img src="images/main_60.gif" width="40" height="15" /></a></div></td><!--尾页 -->
