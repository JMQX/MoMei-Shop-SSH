...
<script type="text/javascript">
	...
	function delbooksList()
	{
		...
		if(isSelected==true)
		{
			...
			{
				document.form1.action="BookServlet?flag=delete_some&statu=recieve";
	...
	{ var bookId=$("#bookId").val();
	    ...
	    {
	       document.form1.action="BookServlet?flag=find&statu=2";
	       document.form1.submit();
	     }
	}
...
<body class="p10">
 ...
 <form action="BookServlet?flag=check_recieve" method="post" name="form1">
       ...
       <tr >
		...
		<td height="20" bgcolor="#FFFFFF">
			<div align="center" class="STYLE21">
			    <a href="BookServlet?flag=finish&bookId=<%=b.getBookId() %>&pageNow=<%=request.getAttribute("pageNow") %>"  />完成</a>
			   |
				<a
				 ...
				 | <a href="BookServlet?flag=delete&bookId=<%=b.getBookId() %>&pageNow=<%=request.getAttribute("pageNow") %>&statu=recieve"  onclick="return confirm('确定删除吗?')"/>删除</a>
			</div>
		</td>
	</tr>
      <%
      ...
      <tr>
        ...
        <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="49"><div align="center"><a href="BookServlet?flag=check_recieve&pageNow=1"><img src="images/main_54.gif" width="40" height="15" /></a></div></td><!--首页 -->
            <%
               if(Integer.parseInt(request.getAttribute("pageNow").toString())!=1)
               {
             %>
            <td width="49"><div align="center"><a href="BookServlet?flag=check_recieve&pageNow=<%=Integer.parseInt(request.getAttribute("pageNow").toString())-1 %>"><img src="images/main_56.gif" width="45" height="15" /></a></div></td><!--前一页 -->
           <%
           }
            %>
            ...
            <%
              ...
              {
             %>
            <td width="49"><div align="center"><a href="BookServlet?flag=check_recieve&pageNow=<%=Integer.parseInt(request.getAttribute("pageNow").toString())+1 %>"><img src="images/main_58.gif" width="45" height="15" /></a></div></td><!--后一页 -->
            <%
            }
             %>
            <td width="49"><div align="center"><a href="BookServlet?flag=check_recieve&pageNow=<%=request.getAttribute("pageCount") %>"><img src="images/main_60.gif" width="40" height="15" /></a></div></td><!--尾页 -->
